...
namespace KateTechPractice
{
    ...
    {        
        ...
        {            
            NewtonPolynomialAppFunc funcNormal = new NewtonPolynomialAppFunc(0, 1.5, 0.15, 0.000001); //вычисление полинома с равномерно распределенными узлами
            ...
            NewtonPolynomialAppFunc funcChebyshev = new NewtonPolynomialAppFunc(0, 1.5, 0.15, 0.000001); //вычисление полинома с корнями полинома Чебышева
